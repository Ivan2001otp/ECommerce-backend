...
func ValidateToken(signedToken string) (claims *SignedDetails, msg string) {
	...
	if err != nil {
		utils.LogMessage("Jwt parsewithClaims throwed error! " + err.Error())
		return
	}
	...
	fmt.Println("firstname->" + claims.First_name)
	fmt.Println("email->" + claims.Email)
	fmt.Println("last name->" + claims.Last_name)
	fmt.Println("uid->" + claims.Uid)
	fmt.Println("role->" + claims.User_role)
